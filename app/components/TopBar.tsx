		...
		<div className="md:px-24 px-10 pt-8 w-full">
			<div className="w-full rounded-xl border-2 border-black flex md:flex-row flex-col py-5 items-center md:gap-y-0 gap-y-5">
				...
				<div className="flex-1 flex justify-around gap-x-5">
					<button className="text-xl border-2 border-[#5055ba] bg-[#5055ba] text-white rounded px-2 py-1">
						Prints
					</button>
					<button className="text-xl border-2 border-[#5055ba] bg-[#5055ba] text-white rounded px-2 py-1">
						Clothing
				...
				<div className="flex space-x-4 mr-2">
					<Link
						className="text-xl border-2 border-[#5055ba] bg-[#5055ba] text-white rounded px-2 py-1"
						href={"/contact"}
					>
						Contact
					</Link>
